...
module.exports = {
    ...
    templates: {
        scriptTagWithHostReplacement: path.join(__dirname, "templates/script-tag-with-host-replacement.tmpl"),
        scriptTagWithoutHostReplacement: path.join(__dirname, "templates/script-tag-without-host-replacement.tmpl"),
